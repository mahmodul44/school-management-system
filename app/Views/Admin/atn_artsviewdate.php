                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        ...
                        <div class="table-responsive">
                            ...
                            <form action="<?php echo base_url('atn_artsupdate' ); ?>" method="post">
                                    ...
                                    <?php if (!empty($atn_artsviewdate)) {
                                        ...
                                        foreach ($atn_artsviewdate as $arts_view) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $arts_view['st_name'] ?></td>
                                                <td><?php echo $arts_view['atn_date'] ?>
                                                    <input type="hidden" name="atn_date[]" value="<?php echo $arts_view['atn_date'] ?>">
                                                </td>

                                                <td> <input type="radio" name="attend[<?php echo $arts_view['id_no']; ?>]"
                                                            value="present" <?php if($arts_view['attend'] == "present") {echo "checked";} ?> >P
                                                    <input type="radio" name="attend[<?php echo $arts_view['id_no']; ?>]"
                                                           value="absent" <?php if($arts_view['attend'] == "absent") {echo "checked";} ?>>A
