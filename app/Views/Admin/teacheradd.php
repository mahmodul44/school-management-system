...
<div class="page-wrapper">
     ...
     <div class="page-breadcrumb bg-white">
          <div class="row align-items-center">
               <div class="col-lg-9 col-md-4 col-sm-6 col-xs-12">
                    <h4 class="page-title text-uppercase font-medium font-14">Teacher Add</h4>
               </div>
               <div class="col-lg-3 col-sm-6 col-md-4 col-xs-12">

                    <a class="btn btn-danger " href="teacher">Teacher List</a>
               </div>
          </div>
     ...
     <div class="col-lg-8 col-xlg-9 col-md-12">
          <div class="card">
               <div class="card-body">
                    <form class="form-horizontal form-material" action="<?php echo site_url('teacherInsert'); ?>"
                         ...
                         <div class="form-group mb-4">
                              <label for="example-email" class="col-md-12 p-0">Ocupation</label>
                              <div class="col-md-12 border-bottom p-0">
                                   <input type="text" placeholder="Teacher Professional Ocupation(If)"
                                        class="form-control p-0 border-0" name="ocupation">
                              </div>
                         </div>
                         <div class="form-group mb-4">
                         ...
                         <div class="form-group mb-4">
                              ...
                              <div class="col-md-12 border-bottom p-0">
                                   <input type="text" placeholder="Enter Addrees" class="form-control p-0 border-0"
